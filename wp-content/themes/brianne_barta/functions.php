...
{
    wp_register_style('brianne_barta', get_template_directory_uri() . '/assets/dist/css/styles.css', array(), '1.0', 'all');
    wp_enqueue_style('brianne_barta', get_stylesheet_directory_uri() . '/assets/dist/css/styles.css');  // Enqueue it!
}
